...
public class ClientsSignedController {
	...
	@GetMapping("/ClientsSigned/GetByClientSigned/{Id_FirmaCliente}")
	public ClientsSigned getOne(@PathVariable(value="Id_FirmaCliente") long Id_FirmaCliente) {
		return ClientsSignedService.getByClientSign(Id_FirmaCliente);
	}
	...
	@DeleteMapping("/ClientsSigned/DeleteSignedByClientId/{Id_FirmaCliente}")
	public void updateByClientId(@PathVariable(value="Id_FirmaCliente") long Id_FirmaCliente) {
		ClientsSignedService.delete(Id_FirmaCliente);
	}
